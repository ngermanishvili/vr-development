        ...
        <>
            <div className="bg-white py-16 px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="text-center ">
                        <h2 className="text-4xl  font-light text-yellow-600 tracking-[0.2em] mb-12">OUR PRIORITIES</h2>
                    </div>
                </div>
            </div>
            <div className="relative">
                ...
                <div className="absolute top-0 right-0 transform -translate-y-full flex items-center space-x-12 md:mr-[18%] pr-8 -mt-4">
                    <span className="text-xl italic text-yellow-600 font-light bg-white px-2">ECOLOGY</span>
                    <span className="text-xl italic text-yellow-600 font-light bg-white px-2">SAFETY</span>
                    <span className="text-xl italic text-yellow-600 font-light bg-white px-2">QUALITY</span>
                </div>
            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                        ...
                        <div className="space-y-12">
                            {/* Mission */}
                            <div>
                                <h3 className="text-2xl italic text-yellow-600 font-light mb-4">MISSION</h3>
                            ...
                            {/* Vision */}
                            <div>
                                <h3 className="text-2xl italic text-yellow-600 font-light mb-4">VISION</h3>
                                <p className="text-gray-700 leading-relaxed text-sm italic">
                            ...
                            <div>
                                <h3 className="text-2xl italic text-yellow-600 font-light mb-4">CREATING A COMFORTABLE <br /> ENVIRONMENT</h3>
                                <p className="text-gray-700 leading-relaxed text-sm italic">
                            ...
                            {/* Professionalism */}
                            <div>
                                <h3 className="text-2xl italic text-yellow-600 font-light mb-4">PROFESSIONALISM</h3>
                                <p className="text-gray-700 leading-relaxed text-sm italic">
