            ...
            <article className="text-black">
              <header className="mb-8">
                ...
                >
                  THE FIRST PHASE
                  <br />
                  <span className="text-3xl sm:text-4xl md:text-5xl text-black" style={{ fontFamily: '"Baskerville Display PT", serif' }}>
                    OF THE PROJECT
                  </span>
                </h1>
              </header>
              ...
              <div className="prose prose-lg max-w-none mb-8">
                <p className="text-lg md:text-xl leading-relaxed text-gray-800" style={{ fontFamily: '"Roboto", sans-serif' }}>
