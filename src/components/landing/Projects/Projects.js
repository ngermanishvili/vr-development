    ...
    return (
        <section className="py-8 px-6">
            <div className="max-w-full mx-auto">
                <h2 className="text-3xl font-light text-center mb-16 text-[#ca9b43] tracking-wider" style={{ fontFamily: 'Baskerville, serif' }}>PROJECTS</h2>
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            ...
                            <div className="absolute top-6 left-10 text-white">
                                <h3 className="text-2xl font-light mb-2" style={{ fontFamily: 'Baskerville, serif' }}>{project.title}</h3>
                            </div>
                        ...
                        {projects.map((project, index) => (
                            <div key={project.id} className="relative flex-shrink-0 w-80 h-96 overflow-hidden rounded-lg">
                                ...
                                <div className="absolute top-6 left-6 text-white">
                                    <h3 className="text-xl font-light mb-2" style={{ fontFamily: 'Baskerville, serif' }}>{project.title}</h3>
                                </div>
