...
const AttractionsSectionLanding = () => {
  ...
  const getPinPositions = () => {
    ...
    if (isMobile) {
      ...
      return [
        { id: 5, left: 34.5, top: 45 },
        { id: 2, left: 29, top: 53 },
        { id: 4, left: 30.5, top: 40 },
        { id: 6, left: 34.7, top: 56 },
        { id: 3, left: 33, top: 51 },
        { id: 7, left: 34, top: 63 },
        { id: 8, left: 30, top: 62.5 },
        { id: 1, left: 26, top: 65.5 },

      ];
    } else {
      // დესკტოპი
      return [
        { id: 5, left: 32.5, top: 47 },
        { id: 2, left: 30, top: 53 },
        { id: 4, left: 30.5, top: 44 },
        { id: 6, left: 34.7, top: 55 },
        { id: 3, left: 33, top: 51 },
        { id: 7, left: 32, top: 62 },
        { id: 8, left: 28.8, top: 62.5 },
        { id: 1, left: 26, top: 65.5 },
...
export default AttractionsSectionLanding;